 ...
 */
public class GetFlexListFromTextAction implements Action<GetFlexListFromTextResult> 
{
  ...
  private String _sUserLdvId ;
	...
	public GetFlexListFromTextAction(final int iUserId, final String sLanguage, final String sStartingText, final int iBoxIndex) 
	{
		super() ;
	...
	public GetFlexListFromTextAction(final String sUserLdvId, final String sLanguage, final String sStartingText, final int iBoxIndex) 
  {
    super() ;
	...
	public GetFlexListFromTextAction() 
	{
		super() ;
